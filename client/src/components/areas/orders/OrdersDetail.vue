            ...
            <form @submit.prevent="save()">
                ...
                <b-field grouped>
                    ...
                    <b-field grouped position="is-right" expanded>
                        <p class="control">
                            <b-tooltip label="Can't edit orders" :active="editing" class="is-primary" position="is-top">
...
export default {
    ...
    beforeMount() {
        ...
        if ((!orderId || Number.isNaN(Number(orderId))) && Session.get().organization.role === "supplier")
